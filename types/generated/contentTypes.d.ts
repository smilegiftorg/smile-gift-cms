...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  info: {
    description: 'Danh s\u00E1ch c\u00E1c b\u00E0i vi\u1EBFt tin t\u1EE9c';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiGalleryGallery extends Schema.CollectionType {
  ...
  info: {
    description: 'Image gallery collection';
    displayName: 'Gallery';
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    seo: Attribute.Component<'shared.seo'>;
    sessions: Attribute.DynamicZone<
      [
        'sections.header',
        'sections.our-story',
...
export interface ApiProgramPageProgramPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    sections: Attribute.DynamicZone<
      ['sections.header', 'sections.join-us-cta']
    >;
    seo: Attribute.Component<'shared.seo'>;
    slug: Attribute.UID<'api::program-page.program-page', 'title'>;
...
export interface ApiProgramProgram extends Schema.CollectionType {
  ...
  info: {
    description: 'Collection for charitable programs/events';
    displayName: 'Program';
    pluralName: 'programs';
...
export interface ApiVolunteerRoleVolunteerRole extends Schema.CollectionType {
  collectionName: 'volunteer_roles';
  info: {
    description: 'C\u00E1c vai tr\u00F2 t\u00ECnh nguy\u1EC7n vi\u00EAn, c\u00F3 th\u1EC3 t\u00E1i s\u1EED d\u1EE5ng \u1EDF nhi\u1EC1u ch\u1ED7';
